...
NODE_TYPES = {
    "DistributionCenter": ["dc_id", "name", "location", "region"],
    "Store": ["store_id", "name", "location", "region", "type"],
    "SKU": ["sku_id", "name", "category", "unit", "temperature_zone"],
    "Truck": ["truck_id", "carrier", "route_id", "status", "current_location"],
    "PurchaseOrder": ["po_id", "date", "status", "delivery_window_start", "delivery_window_end"],
    "Shipment": ["shipment_id", "carrier", "mode", "status", "eta"],
    "InventorySnapshot": ["snapshot_id", "sku_id", "quantity_on_hand", "store_id", "timestamp"],
    "Return": ["return_id", "reason", "date", "condition", "quantity"],
    "WeatherAlert": ["alert_id", "type", "region", "severity", "date"],
